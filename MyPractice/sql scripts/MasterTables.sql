...
CREATE TABLE Department_Master (deptCode varchar(1),deptName varchar(30),PRIMARY KEY (deptCode));
insert into Department_Master values('C','Computer Science');
insert into Department_Master values('A','Admin');
insert into Department_Master values('I','IT');
insert into Department_Master values('M','Management');
insert into Department_Master values('S','Sales');

create table Gender_Master(genderCode varchar(1),gender varchar(6),primary key(genderCode));
insert into Gender_Master values('M','Male');
insert into Gender_Master values('F','Female');

create table Country_Master(countryCode varchar(2),countryName varchar(15),primary key(countryCode));
insert into Country_Master values('US','UNITED STATE');
insert into Country_Master values('IN','INDIA');
insert into Country_Master values('JP','JAPAN');
create table Currency_Master(currencyCode varchar(2),currency varchar(5),primary key(currencyCode));
insert into Currency_Master values('US','$');
insert into Currency_Master values('IN','RUPPE');
insert into Currency_Master values('JP','YEN');

CREATE TABLE COURSE_MASTER(courseCode varchar(5),courseLevel char(1),courseName varchar(50),primary key(courseCode));
...
CREATE TABLE EMPLOYMENT_TYPE(empTypeCode char(1),empTypeString varchar(10),primary key(empTypeCode));


insert into employment_type values('P','PERMANENT');


insert into employment_type values('T','CONTRACT');
SHOW TABLES;
+----------------------+
| Tables_in_spark_data |
+----------------------+
